...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendCode(String email){
        ...
        //redis.opsForValue().set(AUTH_CODE_PREFIX + email, code, CODE_TTL);
    ...
    public boolean isVerified(String email) {
        return verifiedStore.contains(email);
        //return "OK".equals(redis.opsForValue().get(VERIFIED_PREFIX + email)); //key가 없거나 key 값이
        // ok가 아닐떄 false로 반환 (== verifyCode에서 문제 발생 시)
    }
}
